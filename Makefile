...
datasets:
	source venv/bin/activate && convert bundle/analyze/datasets/tap-capsulecrm/ rawdata/ bundle/analyze/datasets/tap-capsulecrm/output || convert bundle/analyze/datasets/tap-capsulecrm/ rawdata/ bundle/analyze/datasets/tap-capsulecrm/output
